...
export default function Header({ getWeather, getCity, input }) {
  const base =
    "flex flex-col items-center w-2/4 mt-5 mb-10 font-raleway text-white tracking-wider";

  return (
    <div
      className="flex flex-col items-center w-2/4 mt-5 mb-10 font-raleway text-white tracking-wider
         animate-fadeIn"
    >
